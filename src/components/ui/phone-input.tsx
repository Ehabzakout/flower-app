...
import { useLocale } from "next-intl"; // 👈 عشان نعرف اللغة الحالية
  ...
  return (
    ...
    >
      ...
      <PopoverContent
        ...
        side={isRTL ? "left" : "right"} // 👈 فتح الـ Popover في الناحية الصح
      >
...
const CountrySelectOption = ({
  ...
  return (
    <CommandItem
      className={cn("gap-2", isRTL && "flex-row-reverse text-right")}
